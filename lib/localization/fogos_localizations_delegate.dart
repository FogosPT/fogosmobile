...
import 'fogos_localizations.dart';

class FogosLocalizationsDelegate extends LocalizationsDelegate<FogosLocalizations> {
  ...
  @override
  Future<FogosLocalizations> load(Locale locale) => FogosLocalizations.load(locale);
